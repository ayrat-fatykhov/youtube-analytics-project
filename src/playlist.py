...
class PlayList:
    ...
    def __init__(self, playlist_id):
        ...
        self.playlist_video = PlayList.youtube.playlists().list(id=playlist_id, part='snippet', maxResults=50).execute()

        self.video_ids: list[str] = [video['contentDetails']['videoId'] for video in self.playlist_videos['items']]
        self.video_response = (PlayList.youtube.videos().list
                               (
    ...
    def show_best_video(self):
        ...
        for id_video in self.video_ids:
            better_video = 0
            video_response = (PlayList.youtube.videos().list
                              (
